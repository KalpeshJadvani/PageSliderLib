...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    public PagerSlidingTab(Context context, AttributeSet attrs) {
        ...
        removeAllViews();
        if (attrs != null) {
            TypedArray attrsTypedArray = context.obtainStyledAttributes(attrs, R.styleable.PagerSlidingTab);
            if (attrsTypedArray != null) {
                allowWidthFull = attrsTypedArray.getBoolean(R.styleable.PagerSlidingTab_allowWidthFull, false);
                slidingBlockDrawable = attrsTypedArray.getDrawable(R.styleable.PagerSlidingTab_slidingBlock);
                disableViewPager = attrsTypedArray.getBoolean(R.styleable.PagerSlidingTab_disableViewPager, false);
                disableTensileSlidingBlock = attrsTypedArray.getBoolean(R.styleable.PagerSlidingTab_disableTensileSlidingBlock, false);
                bottomLineColor = attrsTypedArray.getColor(R.styleable.PagerSlidingTab_bottomLineColor, -1);
                bottomLineHeight = (int) attrsTypedArray.getDimension(R.styleable.PagerSlidingTab_bottomLineHeight, -1);
